...
import { Add, ChatBubble, ChevronRight, Dashboard, ExpandMore, PostAdd, VerifiedUser } from '@mui/icons-material';
        ...
        <div className='sidebar'>
            ...
            <Link>
                ...
                >
                    ...
                    <TreeItem nodeId='50' label="Chat">
                        <Link to="/admin/chat">
                            <TreeItem nodeId='52' label="chat" icon={<ChatBubble />} />
                        </Link>
