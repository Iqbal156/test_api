...
export const createProduct = (productData) => async (dispatch) => {
    ...
    try {
        ...
        //     }
        //   }
        const data = await axios.post(`http://localhost:5000/api/v1/new/product`, productData)
        dispatch({
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`http://localhost:5000/api/v1/update/product/${id}`, productData)
        dispatch({
